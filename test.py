...
def correction_tests():
    ...
    print("\n\nTEST 02 : Degree 1, one solution")
    ComputorV1("5 * X^0 = 4 * X^0 + 7 * X^1")
    print("\n\nTEST 03 : Degree 2, discriminant > 0, two solutions")
    ComputorV1("5 * X^0 + 4 * X^1 - 9.3 * X^2 = 1 * X^0")
    print("\n\nTEST 04 : Degree 2, discriminant = 0, one solution")
    ComputorV1("6 * X^0 + 11 * X^1 + 5 * X^2 = 1 * X^0 + 1 * X^1")
    print("\n\nTEST 05 : Degree 2, discriminant < 0, two complex solutions")
